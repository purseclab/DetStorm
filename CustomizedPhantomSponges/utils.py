# Local NMS (self-contained, with no inplace operation)
...
def non_max_suppression_inplace_free(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
                        labels=(), max_det=300):
